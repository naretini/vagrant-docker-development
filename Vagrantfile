...
echo "Install packages to allow apt to use a repository over HTTPS:\n"
  sudo apt-get install   -y  apt-transport-https     ca-certificates     curl     software-properties-common htop
...
echo "Install the latest version of Docker CE:\n"
  ...
  ############################################################
  # copy of your host machine's .zshrc file to the vagrant box 
